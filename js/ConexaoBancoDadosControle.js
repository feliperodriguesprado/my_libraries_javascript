var ConexaoBancoDadosControle={
    ...
    inicializar:function(){
        ConexaoBancoDadosControle.abrirBancoDados();
    },

    abrirBancoDados:function(){

        // Abrindo o banco. A funcão open() retorna um objeto IDBOpenDBRequest recebido por request
        var request=indexedDB.open(ConexaoBancoDadosControle.nomeBancoDados, ConexaoBancoDadosControle.versaoBancoDados);
        ...
        request.onerror = function(event) {
            this.dataBase = this.result;
            console.log("Erro ao abrir banco de dados.");
            console.log("Banco de dados: " + this.dataBase.name)
            console.log("Versão atual: " + this.dataBase.version);
        };
        ...
        request.onsuccess = function(event) {
            ...
            console.log("Banco de dados: " + this.dataBase.name)
            console.log("Versão: " + this.dataBase.version);
            ObterConexaoBancoDados.dataBase = this.dataBase;
        };
    },
    ...
    excluirBancoDados:function(){
        ...
        var request=indexedDB.deleteDatabase(ConexaoBancoDadosControle.nomeBancoDados);
...
var ObterConexaoBancoDados={
    dataBase: null,
    inicializar: ConexaoBancoDadosControle.inicializar()
};