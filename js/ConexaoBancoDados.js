var ConexaoBancoDados = {
    ...
    inicializar:function() {
        // Esse objeto é inicializado por outro objeto.
    },
    ...
    abrirBancoDados:function() {
        ...
        request.onupgradeneeded = function(event) {
            ...
            ConexaoBancoDados.dataBase = request.result;

            ConexaoBancoDados.dataBase.onerror = function(event) {
                console.log("Erro ao abrir banco de dados para atualizar.");
            };

            ConexaoBancoDados.dataBase.onabort = function(event) {
            ...
            // Tabela "usuario".
            if (!ConexaoBancoDados.dataBase.objectStoreNames[0]) {

                // Criando a tabela "usuario" com uma primary key "usuarioid" auto incremento.
                var objectUsuario = ConexaoBancoDados.dataBase.createObjectStore("usuario", { KeyPath: 'usuarioid', autoIncrement: true});
            ...
            // Tabela "biblioteca".
            if (!ConexaoBancoDados.dataBase.objectStoreNames[1]) {
                
                // Criando a tabela "biblioteca" com uma primary key "bibliotecaid" auto incremento.
                var objectBiblioteca = ConexaoBancoDados.dataBase.createObjectStore("biblioteca", { KeyPath: 'bibliotecaid', autoIncrement: true});
            ...
            // Tabela "emprestimos".
            if (!ConexaoBancoDados.dataBase.objectStoreNames[2]) {
            ...
            ConexaoBancoDados.dataBase.onversionchange = function(event) {
        ...
        request.onerror = function(event) {
            ...
            console.log("Banco de dados: " + ConexaoBancoDados.dataBase.name)
            console.log("Versão atual: " + ConexaoBancoDados.dataBase.version);
        };
        ...
        request.onsuccess = function(event) {
            ...
            console.log("Banco de dados: " + ConexaoBancoDados.dataBase.name)
            console.log("Versão: " + ConexaoBancoDados.dataBase.version);
        };
